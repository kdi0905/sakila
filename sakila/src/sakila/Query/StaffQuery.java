...
public class StaffQuery {
	...
	="SELECT s.username,s.address_id,s.email,s.picture,si.address,si.phone,si.city,si.country FROM staff s inner join staff_list si ON s.staff_id=si.ID WHERE s.staff_id=?";
}
