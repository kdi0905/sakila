			...
			<div style=" margin-top: 70px; margin-left: 30px">
				...
				<div>
					<table class="table" style="width: 80%; text-align: center;">
						...
						<td><a class="btn btn-light" href="${pageContext.request.contextPath}/auth/FilmInventoryServlet?currentPage=1"> << </a></td>
						<td><a class="btn btn-light" href="${pageContext.request.contextPath}/auth/FilmInventoryServlet?currentPage=${currentPage-1}"> < </a></td>
						</c:if>
						...
						<c:forEach var="sp" begin="${firstShow}" end="${lastShow}">
							<c:if test="${sp<=lastPage }">
								...
								<td><a class="btn btn-light" href="${pageContext.request.contextPath}/auth/FilmInventoryServlet?currentPage=${sp}">${sp}</a></td>
								</c:if>
								<c:if test="${sp==currentPage}">
						...
						<td><a class="btn btn-light" href="${pageContext.request.contextPath}/auth/FilmInventoryServlet?currentPage=${currentPage+1}"> > </a></td>
						<td><a class="btn btn-light" href="${pageContext.request.contextPath}/auth/FilmInventoryServlet?currentPage=${lastPage}"> >> </a></td>
						</c:if>
